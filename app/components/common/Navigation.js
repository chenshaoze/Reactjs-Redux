        ...
        return (
            <nav className="navbar-default navbar-static-side" role="navigation">
                    <ul className="nav metismenu" id="side-menu" ref="menu">
                        ...
                        <li className={this.activeRoute("/test")}>
                            <Link to="/test"><i className="fa fa-th-large"></i> <span className="nav-label">Test view</span></Link>
                        </li>
                        <li className={this.activeRoute("/studentManage")}>
                            <Link to="/studentManage"><i className="fa fa-th-large"></i> <span className="nav-label">学生信息管理</span></Link>
                        </li>
                    </ul>
